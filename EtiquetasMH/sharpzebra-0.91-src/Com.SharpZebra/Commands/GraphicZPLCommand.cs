...
namespace Com.SharpZebra.Commands
{
    public partial class ZPLCommands
    {
        ...
        public static string[] GraphicWrite(int left, int top, string imageName)
        {
            
            string zplImageData = string.Empty;
            //Make sure no transparency exists. I had some trouble with this. This PNG has a white background
            
            byte[] binaryData = System.IO.File.ReadAllBytes(imageName);
            ...
            strReturn[0] = "^XA" + "^MNN" + "^LL500" + "~DYE:LOGO,P,P," + binaryData.Length + ",," + zplImageData + "^XZ";
            strReturn[1] = "^FO115,50^IME:LOGO.bmp^FS";
